<template>
  <div class="bg-white">
    <Head>
        <Title>{{ courseDetail.tenKhoaHoc }}</Title>
        <Meta name="decription" :content="courseDetail.moTa"/>
    </Head>
    <div class="mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      >
        ...
        <div class="lg:col-span-4 lg:row-end-1">
          <div
            class="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg"
          >
            <img
        ...
        >
          <div class="flex flex-col-reverse">
            <div class="mt-4">
              ...
              <p class="mt-2 text-sm text-gray-500">
                Version 1.0 (Updated
                <time :datetime="courseDetail.ngayTao">{{ courseDetail.ngayTao }}</time>)
              </p>
            </div>
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            <button
              type="button"
              class="flex w-full items-center justify-center rounded-md border border-transparent bg-purple-800 py-3 px-8 text-base font-medium text-white hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-offset-2 focus:ring-offset-gray-50"
            >
              Add to cart
            </button>
            <button
              type="button"
              class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-50 py-3 px-8 text-base font-medium text-purple-800 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-purple-800 focus:ring-offset-2 focus:ring-offset-gray-50"
            >
              Buy now
            </button>
          </div>
          ...
          <div>
                ...
                <div class="py-10 border-t border-gray-200">
                  ...
                  <div class="prose prose-sm mt-4 max-w-none text-gray-500">
                    <p>
                      ...
                      looks so consistent and each SVG is optimized out of the
                      box so I can use it directly with confidence. It would
                      take me several hours to create a single icon this good,
                      so it's a steal at this price.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <dl>
                ...
                <dd class="prose prose-sm mt-2 max-w-none text-gray-500">
                  <p>
                    The icons are in SVG (Scalable Vector Graphic) format. They
                    can be imported into your design tool of choice and used
                    directly in code.
                  </p>
                </dd>
                ...
                <dd class="prose prose-sm mt-2 max-w-none text-gray-500">
                  <p>
                    ...
                    don&#039;t recommend going smaller than 20 x 20 or larger
                    than 64 x 64 to retain legibility and visual balance.
                  </p>
                </dd>
            ...
            >
              ...
              <div class="prose prose-sm max-w-none text-gray-500">
                ...
                <ul role="list">
                  <li>
                    You're allowed to use the icons in unlimited projects.
                  </li>
                ...
                <ul role="list">
                  ...
                  <li>
                    Make them your own. Change the colors to suit your project
                    or brand.
                  </li>
                </ul>
                ...
                <ul role="list">
                  <li>
                    Don't be greedy. Selling or distributing these icons in
                    their original or modified state is prohibited.
                  </li>
                  <li>
                    Don't be evil. These icons cannot be used on websites or
                    applications that promote illegal or immoral beliefs or
                    activities.
                  </li>
                </ul>
              </div>
...
export default {
  async setup() {
    useHead({
      title: 'Course Detail',
      meta:[
        { name: 'decription', content:'Nuxt 3' }
      ]
    })
    ...
    //Get course detail
    try {
      const uri = `https://elearning0706.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayThongTinKhoaHoc?maKhoaHoc=${route.params.id}`
